...
CHANNEL_CATEGORIES = {
    ...
    "卫视频道": [
        ...
        "绚影4K", "4K乐享", "大湾区卫视", "澳亚卫视", "广州竞赛", "综艺咖秀", "爱宠宠物",  
    ],
    "数字频道": [
...
def get_isp_by_regex(ip):
    if re.match(r"^(1[0-9]{2}|2[0-3]{2}|42|43|58|59|60|61|110|111|112|113|114|115|116|117|118|119|120|121|122|123|124|125|126|127|139|171|175|180|182|183|184|185|186|187|188|189|218|220|221|222|223)\.", ip):
        return "电信"
