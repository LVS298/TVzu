...
CHANNEL_CATEGORIES = {
    ...
    "卫视频道": [
        "湖南卫视", "湖南卫视4K", "浙江卫视", "江苏卫视", "江苏卫视4K", "东方卫视", "东方卫视4K","深圳卫视", "深圳卫视4K", "北京卫视", "北京卫视4K", 
        "广东卫视", "广东卫视4K", "广西卫视", "东南卫视", "海南卫视", "河北卫视", "河南卫视", "湖北卫视", "江西卫视", "四川卫视",
    ...
    "数字频道": [
        ...
        "劲爆体育", "快乐垂钓", "四海钓鱼", "来钓鱼吧", "茶频道", "先锋乒羽", "天元围棋", "汽摩", "梨园频道", "文物宝库", "法制天地", "武术世界", "哒啵赛事", "哒啵电竞", "黑莓电影", "黑莓动画", 
        "乐游", "生活时尚", "都市剧场", "欢笑剧场", "游戏风云", "金色学堂", "动漫秀场", "新动漫", "卡酷少儿", "金鹰卡通", "优漫卡通", "哈哈炫动", "嘉佳卡通", 
        "中国交通", "中国天气", "华数4K", "华数星影", "华数动作影院", "华数喜剧影院", "华数家庭影院", "华数经典电影", "华数热播剧场", "华数碟战剧场",
        "华数军旅剧场", "华数城市剧场", "华数武侠剧场", "华数古装剧场", "华数魅力时尚", "华数少儿动画", "华数动画", "峨眉电影", "爱体育", "爱历史", "爱动漫", 
        "爱喜剧", "爱奇谈", "爱幼教", "爱悬疑", "爱旅行", "爱浪漫", "爱玩具", "爱科幻", "爱谍战", "爱赛车", "爱院线", "BesTV-4K", "BesTV4K-1", "BesTV4K-2",
        "亲子趣学",
    ],
     "湖北": [
...
CHANNEL_MAPPING = {
    ...
    "CHC家庭影院": ["CHC-家庭影院", "家庭影院", "CHC家庭影院HD", "chc家庭影院高清"], 
    ...
    "淘BABY": ["IPTV淘BABY", "北京IPTV淘BABY", "北京淘BABY", "IPTV淘baby", "北京IPTV淘baby", "北京淘baby", "淘Baby"],
    ...
    "峨眉电影": ["四川峨眉HD", "峨眉电影高清", "峨眉电影"],
    "峨眉电影4K": ["4K超高清电影"],
    "绚影4K": ["绚影4K", "睛彩绚影4K", "精彩连播"],
    "4K乐享": ["乐享4K"],
    "爱体育": ["爱体育HD", "IHOT爱体育"],
    "爱历史": ["爱历史HD", "IHOT爱历史"], 
    "爱动漫": ["爱动漫HD", "IHOT爱动漫"], 
