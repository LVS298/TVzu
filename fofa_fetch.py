...
CHANNEL_CATEGORIES = {
    "央视频道": [
        ...
        "央视文化精品", "卫生健康", "电视指南", "中学生", "发现之旅", "书法频道", "国学频道", "环球奇观", "峨眉电影4K"
    ],
    "卫视频道": [
        ...
        "中国教育1台", "中国教育2台", "中国教育3台", "中国教育4台", "早期教育", "新视觉HD"
    ],
    "数字频道": [
        ...
        "华数军旅剧场", "华数城市剧场", "华数武侠剧场", "华数古装剧场", "华数魅力时尚", "华数少儿动画", "华数动画", "峨眉电影"
    ],
    "湖北": [
...
CHANNEL_MAPPING = {
    ...
    "四川卫视": ["四川卫视4K"],
    "浙江卫视": ["浙江卫视4K"],
    "CHC影迷电影": ["CHC影迷电影", "CHC-影迷电影", "影迷电影", "chc影迷电影高清"],
